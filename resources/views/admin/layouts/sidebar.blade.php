        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li>
                ...
                ><i class="far fa-square"></i><span>Services</span></a>
              </li>
              <li>
                <a class="nav-link" 
                  href="{{route('admin.about.index')}}"
                ><i class="far fa-square"></i><span>About</span></a>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" style="display: none;">
                  ...
                  <li><a class="nav-link" href="{{route('admin.feedback-section-setting.index')}}">Section Settings</a></li>
                </ul>
              </li>
